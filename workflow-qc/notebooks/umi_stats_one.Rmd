---
title: "Quality control report (per sample)"
format: html
---
...
raw_qc_data |> 
  ...
  labs(
    ...
    subtitle = str_glue(
      "{sample_id} - {cells} cells",
      sample_id = sample_id,
      cells = sum(raw_qc_data$cellranger_filtered == "cell")
    ),
    x = "Rank (by UMI sum)",
    y = "UMI sum"
  ) +
...
- The plot reports the number of cells filtered by CellRanger.
